...
p = shapvalues_plot(data, L"Content classification$$","png", t_test7(data))
...
p17 = shapvalues17_plot(data17, L"Content classification$$","png", t_test17(data17))
...
p17 = shapvalues17_plot(data17, L"Content classification 500 samples$$","png", t_test17(data17))
