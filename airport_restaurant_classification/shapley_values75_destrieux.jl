...
graphs, labels = load_schema_dataset_destrieux(classification="AR")
...
for i in 1:15
    ...
    model = create_model_destrieux(8, 1; classification="AR")
...
jldsave("airport_restaurant_classification/data/shapleyvalues75_destrieux_15retraining.jld2"; d)
