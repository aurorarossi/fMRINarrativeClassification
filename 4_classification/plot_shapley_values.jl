...
data = load("4_classification/data/shapleyvalues100_5retraining.jld2")
p = shapvalues100_plot(data, L"Combined Modality and Content classiﬁcation$$","png")
display(p)
save("4_classification/plots/shapleyvalues100_5retraining4C.png",p)
