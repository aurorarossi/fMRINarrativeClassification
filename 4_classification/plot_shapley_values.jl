...
p = shapvalues_plot(data, L"Combined Modality and Content classiﬁcation$$","png",t_test7(data))
...
p17 = shapvalues17_plot(data17, L"Combined Modality and Content classiﬁcation$$","png", t_test17(data17))
