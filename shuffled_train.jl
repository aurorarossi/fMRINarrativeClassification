...
function load_schema_dataset(; classification)
    ...
    for (i, name) in enumerate(names)
        _, _, c = split(name, "/")
        g = npzread("data/networks_shuffled/$(c)_network_shuffled_time.npy")[:, :, 1:32]
    ...
    JLD2.@save "/user/aurossi/home/fMRINarrativeClassification/shuffled_timeseries/data/train_4C.jld2" d